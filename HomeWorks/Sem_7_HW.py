...
#song = input('Кричалка Финну Пуха: ')
#song = 'хорошо живет на свете Винни Пух. у него жена и дети, он лопух' # Плохой ритм
song = 'пара-ра-рам рам-пам-папам па-ра-па-да' # Хороший ритм
